          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-riwi-green">156</p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-riwi-yellow">8</p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-riwi-orange">42</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <button
            ...
            className={`bg-white rounded-lg shadow-md overflow-hidden transition-all hover:shadow-lg ${
              activeSection === 'coders' ? 'ring-4 ring-riwi-green' : ''
            }`}
          >
          ...
          <button
            ...
            className={`bg-white rounded-lg shadow-md overflow-hidden transition-all hover:shadow-lg ${
              activeSection === 'organizadores' ? 'ring-4 ring-riwi-yellow' : ''
            }`}
          >
          ...
          <button
            ...
            className={`bg-white rounded-lg shadow-md overflow-hidden transition-all hover:shadow-lg ${
              activeSection === 'eventos' ? 'ring-4 ring-riwi-orange' : ''
            }`}
          >
