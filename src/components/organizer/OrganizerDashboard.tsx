// components/organizador/OrganizerDashboard.tsx
'use client';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          ...
          <button
            ...
            className={`bg-white rounded-lg shadow-md overflow-hidden transition-all hover:shadow-lg md:col-span-2 lg:col-span-1 ${
              activeSection === 'crear' ? 'ring-4 ring-riwi-violet' : ''
            }`}
          >
