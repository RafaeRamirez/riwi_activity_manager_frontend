...
export function InscritosModal({ evento, onClose }: InscritosModalProps) {
  ...
  useEffect(() => {
    ...
    // Simulación de carga de inscritos
    setTimeout(() => {
      setInscritos([
        {
          id: '1',
          ...
          cohorte: 'Cohorte 15',
          fechaInscripcion: new Date('2024-11-20')
        },
        {
          id: '2',
          ...
          cohorte: 'Cohorte 15',
          fechaInscripcion: new Date('2024-11-21')
        },
        {
          id: '3',
          ...
          cohorte: 'Cohorte 14',
          fechaInscripcion: new Date('2024-11-22')
        },
      ]);
      setIsLoading(false);
    }, 500);
