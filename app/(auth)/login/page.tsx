    ...
    return (
        <div className="h-screen w-full flex items-center justify-center bg-gray-100">
            <div className="w-full md:w-[65%] max-w-4xl bg-white shadow-lg rounded-2xl overflow-hidden flex flex-col md:flex-row md:ml-10">
                ...
                <div className="w-full md:w-1/2 h-52 md:h-auto bg-purple-500 flex items-center justify-center relative">
                    {/* Formas decorativas */}
                    <div className="hidden md:block w-full h-full relative">
                        <div className="absolute bottom-12 left-8 flex flex-col gap-4">
                            ...
                            <div className='flex gap-3'>
                                ...
                                {/* Barra naranja */}
                                <div className="w-24 h-11 bg-[var(--riwi-orange)] rounded-full shadow-md"></div>
